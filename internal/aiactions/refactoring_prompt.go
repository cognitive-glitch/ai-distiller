...
// RefactoringPromptAction generates a comprehensive prompt for refactoring analysis
type RefactoringPromptAction struct{}

// Ensure RefactoringPromptAction implements ContentAction
var _ ai.ContentAction = (*RefactoringPromptAction)(nil)
...
func (a *RefactoringPromptAction) Description() string {
	return "Generate AI prompt for comprehensive refactoring analysis"
}

func (a *RefactoringPromptAction) Type() ai.ActionType {
