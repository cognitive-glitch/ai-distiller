...
// ComplexCodebasePromptAction generates a comprehensive codebase analysis prompt
type ComplexCodebasePromptAction struct{}

var _ ai.ContentAction = (*ComplexCodebasePromptAction)(nil)

func (a *ComplexCodebasePromptAction) Name() string {
	return "prompt-for-complex-codebase-analysis"
}

func (a *ComplexCodebasePromptAction) Description() string {
	return "Generate comprehensive codebase analysis prompt with architecture diagrams"
}

func (a *ComplexCodebasePromptAction) Type() ai.ActionType {
	return ai.ActionTypePrompt
}

func (a *ComplexCodebasePromptAction) DefaultOutput() string {
	return "./.aid/COMPLEX-CODEBASE-ANALYSIS.%YYYY-MM-DD.HH-MM-SS%.%folder-basename%.md"
}

func (a *ComplexCodebasePromptAction) Validate() error {
	return nil
}
