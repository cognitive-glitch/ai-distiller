...
// PerformancePromptAction generates a performance-focused analysis prompt
type PerformancePromptAction struct{}

var _ ai.ContentAction = (*PerformancePromptAction)(nil)

func (a *PerformancePromptAction) Name() string {
	return "prompt-for-performance-analysis"
}

func (a *PerformancePromptAction) Description() string {
	return "Generate performance optimization analysis prompt"
}

func (a *PerformancePromptAction) Type() ai.ActionType {
	return ai.ActionTypePrompt
}

func (a *PerformancePromptAction) DefaultOutput() string {
	return "./.aid/PERFORMANCE-ANALYSIS.%YYYY-MM-DD.HH-MM-SS%.%folder-basename%.md"
}

func (a *PerformancePromptAction) Validate() error {
	return nil
}
